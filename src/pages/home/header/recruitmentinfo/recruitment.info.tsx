    ...
    return (
        <div className="recruitment-info-container">
            ...
            <div className="benefits">
                <h3>II - QUYỀN LỢI ỨNG VIÊN:</h3>
                <ul>
                    <li>Chế độ lương, thưởng hấp dẫn (theo năng lực).</li>
                    <li>Thưởng tháng 13 và cuối năm.</li>
                    <li>Chính sách khen thưởng Nhân viên xuất sắc, cống hiến.</li>
                    <li>Được đào tạo, hướng dẫn trong công việc.</li>
                    <li>Định hướng lộ trình thăng tiến rõ ràng.</li>
                    <li>Trải nghiệm sản phẩm công nghệ IT mới nhất.</li>
                    <li>Tham gia Team Building, Du lịch, Nghỉ mát hàng năm.</li>
                    <li>Chế độ Bảo hiểm đầy đủ theo luật Lao động.</li>
                    <li>Cơ hội đào tạo nâng cao chuyên môn khi gắn bó lâu dài.</li>
                    <li>Môi trường làm việc trẻ trung, năng động, thân thiện.</li>
                    <li>Bảo vệ các thành viên dám nghĩ, dám làm, dám thử thách.</li>
                </ul>
            </div>
            ...
            <p className="update-date">CẬP NHẬT: 28.04.2022</p>
        </div>
    );
};
