...
const PrivacyPolicy: React.FC = () => {
    return (
        <div className="privacy-policy">
            ...
            <p>
                Cung cấp dịch vụ cho Khách hàng và quản lý, sử dụng thông tin cá nhân của Người Tiêu Dùng...
            </p>
            ...
            <p>
                Dữ liệu cá nhân sẽ được lưu trữ đến khi có yêu cầu hủy hoặc tự hủy bỏ bởi thành viên...
            </p>
            ...
            <p>
                Người dùng có thể đăng nhập website để tự chỉnh sửa hoặc liên hệ ban quản trị...
            </p>
            ...
            <p>
                Người dùng gửi khiếu nại qua email hoặc gọi hotline để được xử lý. Ban quản trị xác minh và phản hồi sớm nhất...
            </p>
        </div>
    );
};
